...
(deftest
  return-with-logical-and-as-value
  (let [ast (ast/program-node
             :scripts [(ast/function-node
                        :name "foo"
                        :body (ast/block-node
...
(deftest
  script-call-can-provide-less-positional-arguments-than-required
  (let [ast (ast/program-node
             :scripts [(ast/function-node
                        :name "foo"
                        :arguments [(ast/variable-declaration-node "a")
...
(deftest
  script-call-can-provide-less-named-arguments-than-required
  (let [ast (ast/program-node
             :scripts [(ast/function-node
                        :name "foo"
                        :arguments [(ast/variable-declaration-node "a")
