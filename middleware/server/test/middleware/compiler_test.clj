...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
             ...
             [{:__class__ "UziTaskNode",
               ...
               :state "running",
               :tickingRate
               {:__class__ "UziTickingRateNode", :value 1, :scale "s"},
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
             ...
             [{:__class__ "UziTaskNode",
               ...
               {:__class__ "UziBlockNode",
                ...
                [{:__class__ "UziAssignmentNode",
                  :left
                  {:__class__ "UziVariableNode", :name "counter"},
                  :right
        ...
        expected (emit/program
                   :globals
                   #{(emit/variable "counter" 0) (emit/constant 1000)
                     (emit/constant 1)}
                   :scripts
                   [(emit/script
                      :name
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   ...
                   #{(emit/constant 0)}
                   :scripts
                   [(emit/script :name "foo" :delay 0 :running? true)])
        actual (compile ast)]
    (is (equivalent? expected actual))))
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 1)
                     (emit/constant 13)}
                   :scripts
                   [(emit/script
                      :name
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 2)
                     (emit/constant 1)}
                   :scripts
                   [(emit/script
                      :name
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
             :imports [],
             :globals
             [{:__class__ "UziVariableDeclarationNode", :name "b"}],
             :scripts
             [{:__class__ "UziTaskNode",
               :name "default",
               :arguments [],
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
             :imports [],
             :globals
             [{:__class__ "UziVariableDeclarationNode", :name "temp"}],
             :scripts
             [{:__class__ "UziTaskNode",
               :name "default",
               :arguments [],
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/variable "temp" 0)}
                   :scripts
                   [(emit/script
                      :name
                      "default"
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 13)}
                   :scripts
                   [(emit/script
                      :name
                      "default"
        ...
        expected (emit/program
                   ...
                   [(emit/script
                    ...
                    (emit/script
                      ...
                      "default1"
                      :arguments
                      [(emit/variable "arg0#1" 0)]
                      :delay
                      0
                      :instructions
                      [(emit/read-local "arg0#1")
                       (emit/prim-call "toggle")])])
        actual (compile ast)]
    (is (equivalent? expected actual))))
               ...
               {:__class__ "UziBlockNode",
                ...
                [{:__class__ "UziCallNode",
                  ...
                  [{:__class__ "Association",
                    :key nil,
                    :value
                    {:__class__ "UziVariableNode", :name "arg0"}}]}]},
               :arguments
               [{:__class__ "UziVariableDeclarationNode",
                 :name "arg0"}]}],
             :primitives []}
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 1000)}
                   :scripts
                   [(emit/script
                      :name
                      "default"
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
             ...
             [{:__class__ "UziFunctionNode",
               :name "addition",
               :arguments
               [{:__class__ "UziVariableDeclarationNode", :name "x"}
                  ...
                  {:__class__ "UziCallNode",
                   ...
                   [{:__class__ "Association",
                    ...
                    {:__class__ "Association",
                     :key nil,
                     :value
                     {:__class__ "UziVariableNode", :name "y"}}]}}]}}
              {:__class__ "UziTaskNode",
               :name "loop",
               :arguments [],
               :state "running",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 0.75)
                   ...
                   [(emit/script
                      ...
                      "addition"
                      :arguments
                      [(emit/variable "x#1" 0) (emit/variable "y#2" 0)]
                      :delay
                      0
                      :instructions
                      [(emit/read-local "x#1")
  ...
  (let [ast {:__class__ "UziProgramNode",
             ...
             [{:__class__ "UziTaskNode",
              ...
              {:__class__ "UziTaskNode",
               ...
               {:__class__ "UziBlockNode",
                :statements
                [{:__class__ "UziScriptStartNode", :scripts ["loop"]}
        ...
        expected (emit/program
                   ...
                   [(emit/script
                      ...
                      true
                      :instructions
                      [(emit/push-value 13) (emit/prim-call "toggle")])
                    (emit/script
                      :name
                      "main"
                      :delay
                ...
                [{:__class__ "UziCallNode",
                  ...
                  [{:__class__ "Association",
                   ...
                   {:__class__ "Association",
                    :key "c",
                    :value
                    {:__class__ "UziNumberLiteralNode", :value 0.5}}
                   {:__class__ "Association",
                    :key "b",
                    :value
                    {:__class__ "UziNumberLiteralNode", :value 0.75}}],
                  :selector "foo"}]},
               :name "main",
               :state "running",
               :tickingRate nil}
                    ...
                    {:__class__ "UziCallNode",
                     ...
                     [{:__class__ "Association",
                      ...
                      {:__class__ "Association",
                       :key nil,
                       :value
                       {:__class__ "UziVariableNode", :name "c"}}],
                     :selector "+"}}],
                  :selector "write"}]},
               :name "foo",
               :state nil,
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 9)
                     (emit/constant 13)}
                   :scripts
                   [(emit/script
                      :name
                  ...
                  {:__class__ "UziBlockNode",
                   ...
                   [{:__class__ "UziCallNode",
                     ...
                     [{:__class__ "Association",
                       :key nil,
                       :value
                       {:__class__ "UziVariableNode", :name "i"}}],
                     :selector "toggle"}]},
                  :counter
                  {:__class__ "UziVariableDeclarationNode",
                   :name "i",
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   ...
                   [(emit/script
                      ...
                      0
                      :instructions
                      [(emit/push-value 1) (emit/prim-call "retv")])
                    (emit/script
                      :name
                      "main"
                      :delay
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 100)
                   ...
                   [(emit/script
                      ...
                      0
                      :instructions
                      [(emit/push-value 100) (emit/prim-call "retv")])
                    (emit/script
                      :name
                      "main"
                      :delay
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   ...
                   [(emit/script
                      ...
                      0
                      :instructions
                      [(emit/push-value 42) (emit/prim-call "retv")])
                    (emit/script
                      :name
                      "main"
                      :delay
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
             ...
             [{:__class__ "UziTaskNode",
               ...
               :state "stopped",
               :tickingRate
               {:__class__ "UziTickingRateNode", :scale "s", :value 1}}
              {:__class__ "UziTaskNode",
               :arguments [],
               :body
               {:__class__ "UziBlockNode",
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   ...
                   [(emit/script
                      ...
                      0
                      :instructions
                      [(emit/push-value 13) (emit/prim-call "retv")])
                    (emit/script
                      :name
                      "loop"
                      :delay
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 10)
                     (emit/variable "a" 42)}
                   :scripts
                   [(emit/script
                      :name
...
(deftest
  ...
  (let [ast {:__class__ "UziProgramNode",
               ...
               {:__class__ "UziBlockNode",
                ...
                [{:__class__ "UziAssignmentNode",
                 ...
                 {:__class__ "UziVariableDeclarationNode",
                  :name "a",
                  :value
                  {:__class__ "UziNumberLiteralNode", :value 15}}
                 {:__class__ "UziAssignmentNode",
                  :left {:__class__ "UziVariableNode", :name "a"},
                  :right
                  {:__class__ "UziCallNode",
        ...
        expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 15)
                ...
                [{:__class__ "UziConditionalNode",
                  ...
                  {:__class__ "UziBlockNode",
                   ...
                   [{:__class__ "UziVariableDeclarationNode",
                     :name "a",
                     :value
                     {:__class__ "UziNumberLiteralNode", :value 21}}
                    {:__class__ "UziAssignmentNode",
                     :left {:__class__ "UziVariableNode", :name "a"},
                     :right
                     {:__class__ "UziCallNode",
                  ...
                  {:__class__ "UziBlockNode",
                   ...
                   [{:__class__ "UziVariableDeclarationNode",
                     :name "a",
                     :value
                     {:__class__ "UziNumberLiteralNode", :value 11}}
                    {:__class__ "UziAssignmentNode",
                     :left {:__class__ "UziVariableNode", :name "a"},
                     :right
                     {:__class__ "UziCallNode",
