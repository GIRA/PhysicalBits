...
(defn link [ast]
  ...
  (-> ast (l/resolve-imports lib-dir) (dissoc :primitives)))
                             ...
                             :body {:__class__ "UziBlockNode",
                                    :statements [{:__class__ "UziCallNode",
                                                 ...
                                                 {:__class__ "UziCallNode",
                                                  :arguments [{:__class__ "Association",
                                                               :key nil,
                                                               :value {:__class__ "UziVariableNode", :name "ms"}}],
                                                  :selector "t.delayMs"}]},
                        ...
                        :initializationBlock
                                   {:__class__ "UziBlockNode",
                                    :statements [{:__class__ "UziAssignmentNode",
                                                  ...
                                                  :right {:__class__ "UziNumberLiteralNode", :value 10}}
                                                 {:__class__ "UziAssignmentNode",
                                                  :left {:__class__ "UziVariableNode", :name "b"},
                                                  :right {:__class__ "UziNumberLiteralNode", :value 20}}
                                                 {:__class__ "UziAssignmentNode",
                                                  :left {:__class__ "UziVariableNode", :name "c"},
                                                  :right {:__class__ "UziNumberLiteralNode", :value 30}}]},
                        :isResolved false,
                        :path "test_10.uzi"}],
             :scripts []}
        expected {:__class__ "UziProgramNode",
                  :globals [{:__class__ "UziVariableDeclarationNode",
                            ...
                            {:__class__ "UziVariableDeclarationNode",
                             :name "t.b",
                             :value {:__class__ "UziNumberLiteralNode", :value 20}}
                            {:__class__ "UziVariableDeclarationNode",
                             :name "t.c",
                             :value {:__class__ "UziNumberLiteralNode", :value 30}}],
                  :imports [core-import
                            {:__class__ "UziImportNode",
                             :alias "t",
                             :initializationBlock
                  ...
                  :scripts [{:__class__ "UziTaskNode",
                            ...
                            {:__class__ "UziTaskNode",
                             ...
                             :body {:__class__ "UziBlockNode",
                                    :statements [{:__class__ "UziAssignmentNode",
                                                  :left {:__class__ "UziVariableNode", :name "t.a"},
                                                  :right {:__class__ "UziNumberLiteralNode", :value 1}}
                                                 {:__class__ "UziAssignmentNode",
                                                  :left {:__class__ "UziVariableNode", :name "t.b"},
                                                  :right {:__class__ "UziNumberLiteralNode", :value 2}}
                                                 {:__class__ "UziAssignmentNode",
                                                  :left {:__class__ "UziVariableNode", :name "t.c"},
                                                  :right {:__class__ "UziNumberLiteralNode",
                                                          :value 3}}]},
                             :name "t.setup",
                             :state "once"}]}
