...
(deftest
  ...
  (let [expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/constant 11)
                     (emit/constant 13)}
                   :scripts
                   [(emit/script
                      :name
...
(deftest
  ...
  (let [expected (emit/program
                   ...
                   [(emit/script
                      ...
                      0
                      :instructions
                      [(emit/push-value 12) (emit/prim-call "toggle")])
                    (emit/script
                      :name
                      "alive"
                      :delay
...
(deftest
  ...
  (let [expected (emit/program
                   :globals
                   #{(emit/variable "b" 1) (emit/constant 1000)}
                   :scripts
                   [(emit/script
                      :name
                      "blink13"
...
(deftest
  ...
  (let [expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/variable "m.reversePin" 0)
                   ...
                   [(emit/script
                      ...
                      "m.forward"
                      :arguments
                      [(emit/variable "speed#1" 0)]
                      :delay
                      0
                      :instructions
                      [(emit/read-global "m.reversePin")
...
(deftest
  ...
  (let [expected (emit/program
                   :globals
                   #{(emit/constant 0) (emit/variable "c" 0)
                   ...
                   [(emit/script
                      ...
                      "foo.init"
                      :arguments
                      [(emit/variable "en#1" 0)
                       (emit/variable "f#2" 0)
                       (emit/variable "r#3" 0)]
                      :delay
                      0
                      :instructions
                      [(emit/read-local "en#1")
                    ...
                    (emit/script
                      ...
                      0
                      :instructions
                      [(emit/read-global "foo.enablePin")
                       (emit/prim-call "read")
                       (emit/prim-call "retv")])
                    (emit/script
                      :name
