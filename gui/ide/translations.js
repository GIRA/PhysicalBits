...
var TRANSLATIONS = [
  ...
  ["%name . setSpeed (speed: %speed ) ;", "set %name speed to %speed", "fijar velocidad de %name a %speed", "määra mootori %name kiiruseks %speed", "sätt motor %name hastighet till %speed"],
  ["%name .getSpeed( )", "get %name speed", "obtener la velocidad del motor %name", "mootori %name kiirus", "läs %name hastighet"],
