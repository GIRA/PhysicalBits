...
var TRANSLATIONS = [
  ...
  /* "yield" */ ["yield ;", "wait 1 tick", "esperar 1 ciclo", null, null],
  ...
  /* "pin %pin" */ ["%pin", null, "%pin", "viik %pin", null],
  ...
  ["Configure joysticks...", null, "Configurar joysticks...", null, null],
  /* "read joystick x position from %name" */ ["%name .x", "read joystick x position from %name", "leer posición en x de %name", "juhtkangi %name x-telje asend", "läs %name x-position"],
  /* "read joystick y position from %name" */ ["%name .y", "read joystick y position from %name", "leer posición en y de %name", "juhtkangi %name y-telje asend", "läs %name y-position"],
  /* "read joystick angle from %name" */ ["%name .getAngle()", "read angle from %name", "leer ángulo de %name", "juhtkangi %name x-telje nurk kraadides", "läs %name x-position i grader"],
  /* "read joystick magnitude from %name" */ ["%name .getMagnitude()", "read magnitude from %name", "leer magnitud de %name", "juhtkangi %name y-telje nurk kraadides", "läs %name y-position i grader"],
  ...
  /* "boolean %value" */ ["%boolean", null, "%boolean", null, null],
  ...
  /* "number %1" */ ["%number", null, "%number", "arv %number", null],
  ...
  /* "math %constant" */ ["%constant", null, null, null, null],
  ...
  /* "variable %name" */ ["%name", null, null, "muutuja %name", null],
  ...
  /* "arithmetic operator /" */ ["/", "÷", "÷", "÷", "÷"],
  /* "arithmetic operator *" */ ["*", "×", "×", "×", "×"],
  /* "arithmetic operator -" */ ["-", null, null, null, null],
  /* "arithmetic operator +" */ ["+", null, null, null, null],
  /* "arithmetic operator ^" */ ["**", "^", "^", "^", "^"],
  /* "Tasks" */ ["Tasks", null, "Tareas", "Tööd", "Jobb"],
  /* "GPIO" */ ["GPIO", null, "GPIO", "Viigud", "Ben"],
  /* "Motors" */ ["Motors", null, "Motores", "Mootorid", "Motorer"],
  /* "Servo" */ ["Servo", null, "Servo", null, "Servon"],
  /* "DC" */ ["DC", null, "CC", null, null],
  /* "Sensors" */ ["Sensors", null, "Sensores", "Andurid", "Sensorer"],
  /* "Sonar" */ ["Sonar", null, "Sonar", "Kajalood", "Ekolod"],
  /* "Joystick" */ ["Joystick", null, "Joystick", "Juhtkang", null],
  /* "Control" */ ["Control", null, "Control", "Kontroll", "Kontroll"],
  /* "Math" */ ["Math", null, "Matemática", "Aritmeetika", "Matematik"],
  /* "Variables" */ ["Variables", null, "Variables", "Muutujad", "Variabler"],
  /* "Functions" */ ["Functions", null, "Funciones", "Arvutused", "Funktioner"],
  /* "Comments" */ ["Comments", null, "Comentarios", "Kommentaarid", "Kommentarer"],
  /* "Procedures" */ ["Procedures", null, "Procedimientos", "Toimingud", "Procedurer"],
  /* "Configure DC motors..." */ ["Configure DC motors...", null, "Configurar motores CC...", "Seadista mootorid...", "Konfigurera motorer..."],
  /* "Configure sonars..." */ ["Configure sonars...", null, "Configurar sonares...", "Seadista kajalood...", "Konfigurera ekolod..."],
  /* "square root" */ ["square root", null, "raíz cuadrada", "ruutjuur", "roten ur"],
  /* "absolute" */ ["absolute", null, "valor absoluto", "absoluutväärtus", "absolutvärde"],
  /* "logical operator =" */ ["==", "=", "=", "=", "="],
  /* "logical operator ≠" */ ["!=", "≠", "≠", "≠", "≠"],
  /* "logical operator <" */ ["<", null, null, null, null],
  /* "logical operator ≤" */ ["<=", "≤", "≤", "≤", "≤"],
  /* "logical operator >" */ [">", null, null, null, null],
  /* "logical operator ≥" */ [">=", "≥", "≥", "≥", "≥"],
  ...
  /* "ln" */ ["ln", null, null, null, null],
  /* "log10" */ ["log10", null, null, null, null],
  /* "e^" */ ["e^", null, null, null, null],
  /* "10^" */ ["10^", null, null, null, null],
  /* "sin" */ ["sin", null, "seno", null, null],
  /* "cos" */ ["cos", null, "coseno", null, null],
  /* "tan" */ ["tan", null, "tangente", null, null],
  /* "asin" */ ["asin", null, "arcoseno", null, null],
  /* "acos" */ ["acos", null, "arcocoseno", null, null],
  /* "atan" */ ["atan", null, "arcotangente", null, null],
  /* "round" */ ["round", null, "redondear", "ümardamine", "avrunda"],
  ...
  /* "Configure variables..." */ ["Configure variables...", null, "Configurar variables...", "Seadista muutujaid...", "Konfigurera variabler..."],
  /* "Variable name" */ ["Variable name", null, "Nombre de variable", "Muutuja nimi", "Variabelns namn"],
  /* "Initial value (if global)" */ ["Initial value (if global)", null, "Valor inicial (en caso de global)", "Algväärtus (kui on globaalne)", "Initialvärde (om globalt)"],
  /* "Sound" */ ["Sound", null, "Sonido", "Heli", "Ljud"],
  /* "Buttons" */ ["Buttons", null, "Botones", "Lülitid", "Knappar"],
  ...
  /* "button mode INPUT" */ ["INPUT", null, "ENTRADA", "SISEND", "INGÅNG"],
  /* "button mode OUTPUT" */ ["OUTPUT", null, "SALIDA", "VÄLJUND", "UTGÅNG"],
  /* "button mode INPUT PULLUP" */ ["INPUT PULLUP", null, "ENTRADA PULLUP", "PULLUP-SISEND", "PULLUP-INGÅNG"],
  ...
  /* "milliseconds" */ ["milliseconds", null, "milisegundos", "millisekundit", "millisekunder"],
  /* "delay in milliseconds" */ ["delayMs", "milliseconds", "milisegundos", "millisekundit", "millisekunder"],
  /* "seconds" */ ["seconds", null, "segundos", "sekundit", "sekunder"],
  /* "delay in seconds" */ ["delayS", "seconds", "segundos", "sekundit", "sekunder"],
  /* "minutes" */ ["minutes", null, "minutos", "minutit", "minuter"],
  ...
  /* "stopped" */ ["stopped", null, "detenido", "peatatud", "stoppad"],
  /* "forward" */ ["forward", null, "adelante", "edasi", "framåt"],
  /* "backward" */ ["backward", null, "atrás", "tagasi", "bakåt"],
  ...
  /* "while" */ ["while", null, "mientras que", "nii kaua kui kehtib", "medan"],
  /* "until" */ ["until", null, "hasta que", "nii kaua kuni kehtib", "tills"],
  /* "true" */ ["true", null, "verdadero", "tõene", "sann"],
  /* "false" */ ["false", null, "falso", "väär", "falsk"],
