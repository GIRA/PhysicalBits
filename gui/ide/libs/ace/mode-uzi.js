...
define("ace/mode/uzi_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
UziHighlightRules.metaData = {
      comment: 'Uzi language',
      fileTypes: [ 'uzi' ],
      ...
      keyEquivalent: '^~D',
      name: 'Uzi',
      scopeName: 'source.uzi'
};
oop.inherits(UziHighlightRules, TextHighlightRules);

exports.UziHighlightRules = UziHighlightRules;
});
...
define("ace/mode/uzi",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/uzi_highlight_rules","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var UziHighlightRules = require("./uzi_highlight_rules").UziHighlightRules;
var FoldMode = require("./folding/cstyle").FoldMode;

var Mode = function() {
    this.HighlightRules = UziHighlightRules;
...
(function() {
    ...
    this.$id = "ace/mode/uzi";
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    window.require(["ace/mode/uzi"], function(m) {
