...
var TRANSLATIONS = [
  ...
  ["Uzi - Invalid response code: %1", "Uzi - Invalid response code: %1", "Uzi - Código de respuesta inválido: %1", "Uzi – Vigane kostekood: %1", "Uzi - ogiltig svarskod"],
  ...
  ["repeat", "repeat", "repetir", "korda", "upprepa"],
  ["repeat %1 times \n %2", "repeat %1 times \n %2", "repetir %1 veces \n %2", "korda %1 korda \n %2", "upprepa %1 gånger \n %2"],
  ...
  ["task named %1 %2", "task named %1 %2", "tarea llamada %1 %2", "ülesanne nimega %1 %2", "jobb med namn %1 %2"],
  ...
  ["start", "start", "iniciar", "start", "start"],
  ...
  ["seconds", "seconds", "segundos", "sekundit", "sekunder"],
  ["minutes", "minutes", "minutos", "minutit", "minuter"],
  ["second", "second", "segundo", "sekund", "sekund"],
  ["minute", "minute", "minute", "minut", "minut"],
  ["hour", "hour", "hour", "tund", "timme"],
  ["started", "started", "iniciado", "käivitatud", "startad"],
  ["stopped", "stopped", "detenido", "peatatud", "stoppad"],
  ["move %1 %2 at speed %3", "move %1 %2 at speed %3", "mover %1 hacia %2 a velocidad %3", "liiguta mootorit %1 suunas %2 kiirusega %3", "rotera motorn %1 i riktning %2 med hastigheten %2"],
  ["set %1 speed to %2", "set %1 speed to %2", "fijar velocidad de %1 a %2", "määra mootori %1 kiiruseks %2", "sätt motor %1 hastighet till %2"],
  ["read distance from %1 in %2", "read distance from %1 in %2", "leer distancia de %1 en %2", "mõõda kaugus kajaloost %1 ühikutes %2", "läs av avståndet från ekolodet %1 i %2"],
  ["forward", "forward", "adelante", "edasi", "framåt"],
  ["backward", "backward", "atrás", "tagasi", "bakåt"],
  ["mm", "mm", "mm", "mm", "mm"],
  ["cm", "cm", "cm", "cm", "cm"],
  ["m", "m", "m", "m", "m"],
  ["while", "while", "mientras que", "senikaua kuni", "medan"],
  ["until", "until", "hasta que", "kuni", "tills"],
  ["true", "true", "verdadero", "tõene", "sann"],
  ["false", "false", "falso", "väär", "falsk"],
  ["and", "and", "y", "ja", "och"],
  ["or", "or", "o", "või", "eller"],
  ["not", "not", "no", "mitte", "inte"],
  ["is even", "is even", "es par", "on paarisarv", "är ett jämnt tal"],
  ["is odd", "is odd", "es impar", "on paaritu arv", "är ett ojämnt tal"],
  ["is prime", "is prime", "es primo", "on algarv", "är ett primtal"],
  ["is whole", "is whole", "es entero", "on täisarv", "är ett heltal"],
  ["is positive", "is positive", "es positivo", "on positiivne", "är positivt"],
  ["is negative", "is negative", "es negativo", "on negatiivne", "är negativt"],
  ["is divisible by", "is divisible by", "es divisible por", "jaguneb arvuga", "är delbart med"],
  ["Tasks", "Tasks", "Tareas", "Tööd", "Jobb"],
  ["GPIO", "GPIO", "GPIO", "Viigud", "Ben"],
  ["Motors", "Motors", "Motores", "Mootorid", "Motorer"],
  ["Servo", "Servo", "Servo", "Servo", "Servon"],
  ["DC", "DC", "CC", "DC", "DC"],
  ["Sensors", "Sensors", "Sensores", "Andurid", "Sensorer"],
  ["Sonar", "Sonar", "Sonar", "Kajalood", "Ekolod"],
  ["Control", "Control", "Control", "Kontroll", "Kontroll"],
  ["Math", "Math", "Matemática", "Aritmeetika", "Matematik"],
  ["Variables", "Variables", "Variables", "Muutujad", "Variabler"],
  ["Functions", "Functions", "Funciones", "Funktsioonid", "Funktioner"],
  ["Comments", "Comments", "Comentarios", "Kommentaarid", "Kommentarer"],
  ["Procedures", "Procedures", "Procedimientos", "Protseduurid", "Procedurer"],
  ["Configure DC motors...", "Configure DC motors...", "Configurar motores CC...", "Seadista mootorid...", "Konfigurera motorer..."],
  ["Configure sonars...", "Configure sonars...", "Configurar sonares...", "Seadista kajalood...", "Konfigurera ekolod..."],
  ["random integer from %1 to %2", "random integer from %1 to %2", "número entero al azar entre %1 y %2", "suvaline täisarv %1 ja %2 vahel", "slumpmässigt heltal mellan %1 och %2"],
  ["constrain %1 low %2 high %3", "constrain %1 low %2 high %3", "mantener %1 entre %2 y %3", "piira %1 olema %2 ja %3 vahel", "begränsa %1 att vara mellan %2 och %3"],
  ["random fraction", "random fraction", "fracción al azar", "suvaline murdarv 0.0 ja 1.0 vahel", "slumpmässig bråkdel mellan 0.0 och 1.0"],
  ["square root", "square root", "raíz cuadrada", "ruutjuur", "roten ur"],
  ["absolute", "absolute", "valor absoluto", "absoluutväärtus", "absolutvärde"],
  ["-", "-", "-", "-", "-"],
  ["ln", "ln", "ln", "ln", "ln"],
  ["log10", "log10", "log10", "log10", "log10"],
  ["e^", "e^", "e^", "e^", "e^"],
  ["10^", "10^", "10^", "10^", "10^"],
  ["sin", "sin", "seno", "sin", "sin"],
  ["cos", "cos", "coseno", "cos", "cos"],
  ["tan", "tan", "tangente", "tan", "tan"],
  ["asin", "asin", "arcoseno", "asin", "asin"],
  ["acos", "acos", "arcocoseno", "acos", "acos"],
  ["atan", "atan", "arcotangente", "atan", "atan"],
  ["round", "round", "redondear", "ümardamine", "avrunda"],
  ["round up", "round up", "redondear hacia arriba", "ümarda üles", "avrunda uppåt"],
  ["round down", "round down", "redondear hacia abajo", "ümarda alla", "avrunda nedåt"],
  ...
  ["Configure variables", "Configure variables", "Configurar variables", "Seadista muutujaid", "Konfigurera variabler"],
  ["Variable name", "Variable name", "Nombre de variable", "Muutuja nimi", "Variabelns namn"],
  ["declare local variable %1 with value %2", "declare local variable %1 with value %2", "declarar variable local %1 con valor %2", "loo muutuja %1 väärtusega %2", "skapa variabeln %1 med värdet %2"],
  ["set %1 to %2", "set %1 to %2", "establecer %1 a %2", "määra %1 väärtuseks %2", "sätt värdet på %1 till %2"],
  ["increment %1 by %2", "increment %1 by %2", "incrementar %1 por %2", "kasvata %1 suurusega %2", "lägg till %2 på %1"],
  ["procedure named %1 %2", "procedure named %1 %2", "procedimiento llamado %1 %2", "protseduur nimega %1 %2", "procedur med namn %1 %2"],
  ["procedure named %1 with argument %2 %3", "procedure named %1 with argument %2 %3", "procedimiento llamado %1 con argumento %2 %3", "protseduur nimega %1 argumendiga %2 %3", "procedur med namn %1 och argumentet %2 %3"],
  ["procedure named %1 with arguments %2 %3 %4", "procedure named %1 with arguments %2 %3 %4", "procedimiento llamado %1 con argumentos %2 %3 %4", "protseduur nimega %1 argumentidega %2 %3 %4", "procedur med namn %1 och argumenten %2 %3 %4"],
  ["procedure named %1 with arguments %2 %3 %4 %5", "procedure named %1 with arguments %2 %3 %4 %5", "procedimiento llamado %1 con argumentos %2 %3 %4 %5", "protseduur nimega %1 argumentidega %2 %3 %4 %5", "procedur med namn %1 och argumenten %2 %3 %4 %5"],
  ["exit", "exit", "salir", "välju", "stäng"],
  ["execute", "execute", "ejecutar", "jooksuta", "kör"],
  ["function named %1 %2", "function named %1 %2", "función llamada %1 %2", "funktsioon nimega %1 %2", "funktion med namn %1 %2"],
  ["function named %1 with argument %2 %3", "function named %1 with argument %2 %3", "función llamada %1 con argumento %2 %3", "funktsioon nimega %1 argumentidega %2 %3", "funktion med namn %1 och argumentet %2 %3"],
  ["function named %1 with arguments %2 %3 %4", "function named %1 with arguments %2 %3 %4", "función llamada %1 con argumentos %2 %3 %4", "funktsioon nimega %1 argumentidega %2 %3 %4", "funktion med namn %1 och argument %2 %3 %4"],
  ["function named %1 with arguments %2 %3 %4 %5", "function named %1 with arguments %2 %3 %4 %5", "función llamada %1 con argumentos %2 %3 %4 %5", "funktsioon nimega %1 argumentidega %2 %3 %4 %5", "funktion med namn %1 och argument %2 %3 %4 %5"],
  ["return", "return", "devolver", "tagasta", "svara"],
  ["evaluate", "evaluate", "evaluar", "arvuta", "beräkna"],
  ["Sound", "Sound", "Sonido", "Heli", "Ljud"],
  ["play tone %1 on pin %2", "play tone %1 on pin %2", "reproducir tono %1 en el pin %2", "mängi tooni %1 viigus %2", "spela tonen %1 på ben %2"],
  ["play tone %1 on pin %2 for %3 %4", "play tone %1 on pin %2 for %3 %4", "reproducir tono %1 en el pin %2 durante %3 %4", "mängi tooni %1 viigus %2 %3 %4", "spela tonen %1 på ben %2 under %3 %4"],
  ["stop tone on pin %1", "stop tone on pin %1", "detener tono en el pin %1", "peata toon viigus %1", "sluta tonen på ben %1"],
  ["stop tone on pin %1 and wait %2 %3", "stop tone on pin %1 and wait %2 %3", "detener tono en el pin %1 y esperar %2 %3", "peata toon viigus %1 ja oota %2 %3", "sluta tonen på ben %1 och vänta %2 %3"],
  ["Buttons", "Buttons", "Botones", "Lülitid", "Knappar"],
  ["is button %1 on pin %2", "is button %1 on pin %2", "está %1 el botón en el pin %2", "kas lüliti on %1 viigus %2", "är knapp %1 på ben %2"],
  ["wait for button %1 on pin %2", "wait for button %1 on pin %2", "esperar hasta que %1 el botón en el pin %2", "oota lüliti %1 viigus %2", "vänta på knapp %1 på ben %2"],
  ["elapsed milliseconds while pressing %1", "elapsed milliseconds while pressing %1", "milisegundos transcurridos presionando el pin %1", "möödunud aeg millisekundites %1 vajutuse ajal", "förfluten tid i millisekunder medan %1 nedtryckt"],
  ["pressed", "pressed", "presionado", "vajutatud", "nedtryckt"],
  ["released", "released", "suelto", "vabastatud", "släppt"],
  ["press", "press", "presione", "vajutamist", "tryck"],
  ["release", "release", "suelte", "vabastamist", "släpp"],
];
