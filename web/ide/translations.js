...
var TRANSLATIONS = [
    ...
    ["This variable is being used by the program!", "¡Esta variable está siendo usada en el programa!", "Hetkel kasutatakse seda muutujat mujal programmis!"],
    ["This motor is being used by the program!", "¡Este motor está siendo usado en el programa!", "Hetkel kasutatakse seda mootorit mujal programmis!"],
    ["This sonar is being used by the program!", "¡Este sonar está siendo usado en el programa!", "Hetkel kasutatakse seda kajaloodi mujal programmis!"],

    // Server
    ["Program size (bytes): %1", "Tamaño del programa (en bytes): %1", "Programmi suurus (baitides): %1"],
    ["Compilation successful!", "¡Compilación exitosa!", "Kompileerimine õnnestus!!"],
    ["Connecting on serial...", "Conectando por serie...", "Ühendatakse jadapordiga..."],
    ["Connecting on socket...", "Conectando por socket...", "Ühendatakse kiibipesaga..."],
    ["Installed program successfully!", "¡Programa instalado correctamente!", "Programm installimie õnnestus!"],
    ["Opening port: %1", "Abriendo puerto: %1", "Avatakse jadaporti: %1"],
    ["Opening port failed!", "¡La apertura del puerto falló!", "Jadapordi avamine nurjus!"],
    ["Connection lost!", "¡Conexión perdida!", "Ühendus katkes!"],
    ["%1 detected. The program has been stopped.", "Se detectó %1. El programa ha sido detenido.", "%1 avastatud. Programm on peatatud."],
    ["Free Arduino RAM: %1 bytes", "RAM de Arduino disponible: %1 bytes", "Vaba muutmälu Arduinos: %1 baiti"],
    ["Free Uzi RAM: %1 bytes", "RAM de Uzi disponible: %1 bytes", "Vaba töömälu Uzi jaoks: %1 baiti"],
    ["Uzi - Invalid response code: %1", "Uzi - Código de respuesta inválido: %1", "Uzi – Vigane kostekood: %1"],
    ["Connection timeout!", "¡Expiró el tiempo de espera de la conexión!", "Ühendus aegus!"],
    ['%1 detected on script "%2". The script has been stopped.', 'Se detectó %1 en el script "%2". El script ha sido detenido.', '%1 avastatud skriptis "%2". Skript on peatatud.'],
    ["Requesting connection...", "Solicitando conexión...", "Ühendust taotletakse..."],
    ["Connection accepted!", "¡Conexión aceptada!", "Ühendus aktsepteeriti!"],
    ["Connection rejected", "Conexión rechazada", "Ühendus lükati tagasi!"],
    ["Connection timeout", "Expiró el tiempo de espera de la conexión", "Ühendus aegus"],
