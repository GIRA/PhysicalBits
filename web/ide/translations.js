...
var TRANSLATIONS = [
    ...
    ["read distance from % in %", "leer distancia de % en %", "mõõda kaugust %-st %-s"],
    ...
    ["Configure sonars...", "Configurar sonares...", "Seadista kajalood..."],
    ["random integer from % to %", "número entero al azar entre % y %", "random integer from % to %"],
    ["constrain % low % high %", "mantener % entre % y %", "constrain % low % high %"],
    ["random fraction", "fracción al azar", "random fraction"],
    ["square root", "raíz cuadrada", "square root"],
    ["absolute", "valor absoluto", "absolute"],
    ["-", "-", "-"],
    ["ln", "ln", "ln"],
    ["log10", "log10", "log10"],
    ["e^", "e^", "e^"],
