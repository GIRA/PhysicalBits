...
(deftest Test043ForLoop-uzi-string
...
(deftest Test044ReversedForLoop-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 0)
                                (emit/constant 11)
                                (emit/constant 7)
...
(deftest Test045ForLoopWithoutConstantStep-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "step" 1)
                                (emit/constant 0)
                                (emit/constant 7)
...
(deftest Test046ReverseForLoopWithoutConstantStep-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "step" -1)
                                (emit/constant 0)
                                (emit/constant 11)
...
(deftest Test047ForLoopShouldOnlyEvaluateStepOncePerIteration-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "step" -1)
                                (emit/variable "stop" -10)
                                (emit/constant 0)
...
(deftest Test048MutexShouldGuaranteeACriticalSection-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "m.lock" 0)
                                (emit/variable "m.owner" -1)
                                (emit/constant 0)
...
(deftest Test049ChannelShouldDeadlockIfConsumingFromTheSameTaskAsProducer-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "c.value" 0)
                                (emit/variable "c.state" 0)
                                (emit/variable "c.r_turn" -1)
...
(deftest Test050ChannelWithMultipleProducersAndNoConsumerShouldBlockAllProducers-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "c.value" 0)
                                (emit/variable "c.state" 0)
                                (emit/variable "c.s_turn" -1)
...
(deftest Test051ChannelWithOneProducerAndOneConsumerBlocksTheProducerAtTheRateOfConsumer-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "c.value" 0)
                                (emit/variable "c.state" 0)
                                (emit/variable "c.r_turn" -1)
...
(deftest Test052ChannelWithMultipleProducersAndOneConsumer-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "c.value" 0)
                                (emit/variable "c.state" 0)
                                (emit/variable "c.r_turn" -1)
...
(deftest Test053ChannelWithMultipleConsumersAndOneProducer-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "c.value" 0)
                                (emit/variable "c.state" 0)
                                (emit/variable "c.r_turn" -1)
...
(deftest Test054VariablesWithTheSameNameInDifferentScopesShouldNotInterfereWithEachOther-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 1)
                                (emit/constant 7)
...
(deftest Test055VariablesWithTheSameNameInDifferentScopesShouldNotInterfereWithEachOther-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 1)
                                (emit/constant 7)
...
(deftest Test056Round-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 10)
                                (emit/constant 0.25)
...
(deftest Test057Ceil-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 10)
                                (emit/constant 0.25)
...
(deftest Test058Floor-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 10)
                                (emit/constant 0.25)
...
(deftest Test059Sqrt-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 9)
                                (emit/constant 0.25)}
...
(deftest Test061NaturalLogarithm-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 1)
...
(deftest Test062Log10-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 1)
...
(deftest Test064Pow10-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant -3)
...
(deftest Test065IsCloseTo-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 1)
                                (emit/constant 1.00001)
...
(deftest Test066Asin-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 0)
...
(deftest Test067Acos-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 1)
...
(deftest Test068Atan-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 0)
...
(deftest Test069Power-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 0)
...
(deftest Test070IsOn-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 13)}
                    :scripts [(emit/script
...
(deftest Test071IsOff-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 13)}
                    :scripts [(emit/script
...
(deftest Test073Constrain-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant -10)
...
(deftest Test074RandomInt-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "old" 0)
                                (emit/constant 1000)
                                (emit/constant 0)
...
(deftest Test075Random-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "old" 0)
                                (emit/constant 1000)
                                (emit/constant 0)
...
(deftest Test076IsEven-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 1)
...
(deftest Test077IsOdd-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 0)
...
(deftest Test078IsPrime-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 9)
...
(deftest Test079IsWhole-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 9.5)
...
(deftest Test080IsPositive-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant -10)
...
(deftest Test081IsNegative-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 0)
...
(deftest Test082IsDivisibleBy-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 7)
                                (emit/constant 9)
...
(deftest Test085Minutes-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 0)
                                (emit/constant 1)
                                (emit/constant 13)
...
(deftest Test086Seconds-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 0)
                                (emit/constant 1)
                                (emit/constant 13)
...
(deftest Test087Millis-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 0)
                                (emit/constant 1000)
                                (emit/constant 13)
...
(deftest Test088ScriptCallOverridingPrimitive-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 13)
                                (emit/constant 0)}
...
(deftest Test089DebuggerBreakpointHaltsAllScripts-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 1000)
                                (emit/constant 11)
                                (emit/constant 0)
...
(deftest Test091ChangingTheProgramResetsTheVMState-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/constant 0)
                                (emit/constant 13)
                                (emit/constant 1000)}
...
(deftest Test094ProgramWithMultipleImports-uzi-string
  (let [expected (en/encode (emit/program
                    :globals #{(emit/variable "sonar.trigPin" 0)
                                (emit/variable "sonar.echoPin" 0)
                                (emit/variable "sonar.maxDistance" 100)
