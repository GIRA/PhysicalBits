...
| Platform | File(s) |
| :---: |:---:|
| ![windows](https://gira.github.io/PhysicalBits/img/windows.png)<br>Windows | [PhysicalBits.v1.0-desktop-win32.zip](https://github.com/GIRA/PhysicalBits/releases/download/v1.0/PhysicalBits.v1.0-desktop-win32.zip) |
