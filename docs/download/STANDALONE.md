...
| Platform | File(s) |
| :---: |:---:|
| ![windows](https://gira.github.io/PhysicalBits/img/windows.png)<br>Windows | [PhysicalBits.v0.6.1-desktop-win32.zip](https://github.com/GIRA/PhysicalBits/releases/download/v0.6.1/PhysicalBits.v0.6.1-desktop-win32.zip) |
