...
var TRANSLATIONS = [
  ...
  ["Welcome to the online DEMO of the Physical Bits environment!", "Welcome to the online DEMO of the Physical Bits environment!", "¡Bienvenido a la DEMO online de Physical Bits!", null, null],
  ["This DEMO is intended to showcase the editor and its capabilities. Therefore, its functionality is limited and it doesn't currently support connecting to a device in order to interactively program it.", "This DEMO is intended to showcase the editor and its capabilities. Therefore, its functionality is limited and it doesn't currently support connecting to a device in order to interactively program it.", "El objetivo de esta DEMO es exhibir el editor y sus capacidades. Por lo tanto, su funcionalidad es limitada y actualmente no soporta la conexión con un dispositivo para poder programarlo de forma interactiva.", null, null],
  ["If you want to experience the full benefits of this programming environment, please download an appropriate version for your OS here:", "If you want to experience the full benefits of this programming environment, please download an appropriate version for your OS here:", "Si te interesa experimentar todos los beneficios de este entorno de programación, te recomendamos descargar una versión apropiada para tu sistema operativo:", null, null],
  ["DOWNLOADS", "DOWNLOADS", "DESCARGAS", "DOWNLOADS", "DOWNLOADS"],
